...
final class Version20260410000001 extends AbstractMigration
{
    ...
    {
        return 'Create clinic__clinic_memberships table (moved from AccessControl BC)';
    }

    public function up(Schema $schema): void
    {
        $this->addSql(<<<'SQL'
            CREATE TABLE clinic__clinic_memberships (
    ...
    {
        $this->addSql('DROP TABLE clinic__clinic_memberships');
    }
}
