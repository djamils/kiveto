...
final class Version20260420000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_pb_clinic_staff ON scheduling__planning_blocks (clinic_id, staff_user_id, date)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_pb_clinic_pract ON scheduling__planning_blocks (clinic_id, practitioner_user_id, date)');
    }
}
