...
final class Version20260125003702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE animal__ownership (
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              animal__ownership
            ADD
              CONSTRAINT FK_88F9956D8E962C16 FOREIGN KEY (animal_id) REFERENCES animal__animal (id) ON DELETE CASCADE
        SQL);
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE animal__ownership DROP FOREIGN KEY FK_88F9956D8E962C16');
        $this->addSql('DROP TABLE animal__animal');
        $this->addSql('DROP TABLE animal__ownership');
    }
}
