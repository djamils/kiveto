...
final class Version20260410000001 extends AbstractMigration
{
    ...
    {
        return 'Create Consultation BC tables (renamed from ClinicalCare)';
    }

    public function up(Schema $schema): void
    {
        $this->addSql(<<<'SQL'
            CREATE TABLE consultation__clinical_notes (
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE consultation__performed_acts (
              id VARBINARY(16) NOT NULL,
              consultation_id VARBINARY(16) NOT NULL,
    ...
    {
        $this->addSql('DROP TABLE consultation__clinical_notes');
        $this->addSql('DROP TABLE consultation__consultations');
        $this->addSql('DROP TABLE consultation__performed_acts');
    }
}
