...
namespace App\Tests\Unit\System\Translation\Domain;

use App\Shared\Domain\Localization\Locale;
use App\System\Translation\Domain\Event\TranslationDeleted;
use App\System\Translation\Domain\Event\TranslationUpserted;
...
final class TranslationCatalogTest extends TestCase
{
    ...
    public function testReconstituteAndHelpers(): void
    {
        ...
        $entry = new \App\System\Translation\Domain\TranslationEntry(
