...
namespace App\Tests\Unit\System\IdentityAccess\Infrastructure\Persistence\Doctrine\Repository;
...
use App\System\IdentityAccess\Infrastructure\Persistence\Doctrine\Repository\DoctrineUserRepository;
...
final class DoctrineUserRepositoryTest extends TestCase
{
    ...
    private function entity(UserType $type): UserEntity
    {
        ...
        $entity->setStatus(\App\System\IdentityAccess\Domain\ValueObject\UserStatus::ACTIVE);
