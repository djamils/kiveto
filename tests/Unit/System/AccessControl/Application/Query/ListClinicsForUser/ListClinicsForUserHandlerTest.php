...
namespace App\Tests\Unit\System\AccessControl\Application\Query\ListClinicsForUser;
...
use App\System\AccessControl\Application\Query\ListClinicsForUser\ListClinicsForUserHandler;
    ...
    public function testHandlerCallsRepositoryWithCorrectUserId(): void
    {
        ...
        $repository->expects(self::once())
            ...
            ->with(self::callback(static function (mixed $userId): bool {
                return $userId instanceof \App\System\AccessControl\Domain\ValueObject\UserId
