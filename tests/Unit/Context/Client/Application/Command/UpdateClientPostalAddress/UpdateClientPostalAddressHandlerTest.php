...
namespace App\Tests\Unit\Context\Client\Application\Command\UpdateClientPostalAddress;

use App\Context\Client\Application\Command\UpdateClientPostalAddress\PostalAddressDto;
use App\Context\Client\Application\Command\UpdateClientPostalAddress\UpdateClientPostalAddress;
use App\Context\Client\Application\Command\UpdateClientPostalAddress\UpdateClientPostalAddressHandler;
...
final class UpdateClientPostalAddressHandlerTest extends TestCase
{
    public function testHandleUpdatesPostalAddress(): void
    {
        ...
        $handler = new UpdateClientPostalAddressHandler($clientRepository, new DomainEventPublisher($eventBus), $clock);
        $handler($command);
    }

    public function testHandleUpdatesPostalAddressToNull(): void
    {
        $clinicId  = ClinicId::fromString('12345678-9abc-def0-1234-56789abcdef0');
        $clientId  = ClientId::fromString('01234567-89ab-cdef-0123-456789abcdef');
        $now       = new \DateTimeImmutable('2024-01-02 14:00:00');
