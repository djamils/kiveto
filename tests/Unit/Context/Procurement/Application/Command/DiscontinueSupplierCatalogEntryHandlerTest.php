...
use App\Context\Procurement\Application\Command\DiscontinueSupplierCatalogEntry\DiscontinueSupplierCatalogEntry;
use App\Context\Procurement\Application\Command\DiscontinueSupplierCatalogEntry\DiscontinueSupplierCatalogEntryHandler;
...
final class DiscontinueSupplierCatalogEntryHandlerTest extends TestCase
{
    ...
    public function testItDiscontinuesEntry(): void
    {
        ...
        $this->makeHandler($repository, $eventBus)(new DiscontinueSupplierCatalogEntry(entryId: self::ENTRY_UUID));
    ...
    public function testItThrowsWhenEntryNotFound(): void
    {
        ...
        $this->makeHandler($repository, $this->createStub(EventBusInterface::class))(new DiscontinueSupplierCatalogEntry(entryId: self::ENTRY_UUID));
    }

    private function makeHandler(
        SupplierCatalogEntryRepositoryInterface $repository,
        EventBusInterface $eventBus,
    ): DiscontinueSupplierCatalogEntryHandler {
        ...
        return new DiscontinueSupplierCatalogEntryHandler(
            $repository,
