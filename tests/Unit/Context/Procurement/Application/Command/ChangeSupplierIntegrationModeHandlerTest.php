...
use App\Context\Procurement\Application\Command\ChangeSupplierIntegrationMode\ChangeSupplierIntegrationMode;
use App\Context\Procurement\Application\Command\ChangeSupplierIntegrationMode\ChangeSupplierIntegrationModeHandler;
...
final class ChangeSupplierIntegrationModeHandlerTest extends TestCase
{
    private const string SUPPLIER_UUID = '01932b00-0000-7000-8000-000000000001';

    public function testItChangesIntegrationMode(): void
    {
        ...
        $this->makeHandler($repository, $eventBus)(new ChangeSupplierIntegrationMode(
            supplierId: self::SUPPLIER_UUID,
            newMode: SupplierIntegrationMode::AUTOMATIC->value,
            adapterIdentifier: 'centravet_ftp',
        ));
    ...
    public function testItThrowsWhenSupplierNotFound(): void
    {
        ...
        $this->makeHandler($repository, $this->createStub(EventBusInterface::class))(new ChangeSupplierIntegrationMode(
            supplierId: self::SUPPLIER_UUID,
            newMode: SupplierIntegrationMode::MANUAL_EXPORT->value,
    ...
    private function makeHandler(
    ...
    ): ChangeSupplierIntegrationModeHandler {
        ...
        return new ChangeSupplierIntegrationModeHandler(
            $repository,
