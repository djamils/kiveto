...
use App\Context\Procurement\Application\Command\RenameSupplier\RenameSupplier;
use App\Context\Procurement\Application\Command\RenameSupplier\RenameSupplierHandler;
...
final class RenameSupplierHandlerTest extends TestCase
{
    private const string SUPPLIER_UUID = '01932b00-0000-7000-8000-000000000001';

    public function testItRenamesSupplier(): void
    {
        ...
        $this->makeHandler($repository, $eventBus)(new RenameSupplier(
            supplierId: self::SUPPLIER_UUID,
            newName: 'NewName',
        ));

        self::assertSame('NewName', $supplier->name()->toString());
    }
    ...
    public function testItThrowsWhenSupplierNotFound(): void
    {
        ...
        $this->makeHandler($repository, $this->createStub(EventBusInterface::class))(new RenameSupplier(
            supplierId: self::SUPPLIER_UUID,
            newName: 'NewName',
        ));
    }
    ...
    private function makeHandler(
        ...
        return new RenameSupplierHandler(
            $repository,
