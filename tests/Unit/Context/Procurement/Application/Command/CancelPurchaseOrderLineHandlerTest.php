...
use App\Context\Procurement\Application\Command\CancelPurchaseOrderLine\CancelPurchaseOrderLine;
use App\Context\Procurement\Application\Command\CancelPurchaseOrderLine\CancelPurchaseOrderLineHandler;
...
final class CancelPurchaseOrderLineHandlerTest extends TestCase
{
    ...
    public function testItCancelsLineOnSubmittedPurchaseOrder(): void
    {
        ...
        ($this->makeHandler($repository))(new CancelPurchaseOrderLine(
            purchaseOrderId: self::PO_UUID,
            lineId: self::LINE_UUID,
            reason: 'Out of stock',
        ));

        self::assertSame(PurchaseOrderLineStatus::CANCELLED, $po->lines()[0]->status());
    }
    ...
    private function makeHandler(PurchaseOrderRepositoryInterface $repository): CancelPurchaseOrderLineHandler
    {
        ...
        return new CancelPurchaseOrderLineHandler(
            $repository,
