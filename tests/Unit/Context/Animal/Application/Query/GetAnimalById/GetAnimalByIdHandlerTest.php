...
namespace App\Tests\Unit\Context\Animal\Application\Query\GetAnimalById;
...
final class GetAnimalByIdHandlerTest extends TestCase
{
    public function testHandleReturnsView(): void
    {
        ...
        $view = new AnimalView(
            ...
            identification: new \App\Context\Animal\Application\Query\GetAnimalById\IdentificationDto(
            ...
            transfer: new \App\Context\Animal\Application\Query\GetAnimalById\TransferDto(
                transferStatus: 'none',
                soldAt: null,
                givenAt: null
            ),
