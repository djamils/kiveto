...
namespace App\Tests\Unit\Context\Animal\Application\Command\UpdateAnimalTransfer;

use App\Context\Animal\Application\Command\UpdateAnimalTransfer\UpdateAnimalTransfer;
use App\Context\Animal\Application\Command\UpdateAnimalTransfer\UpdateAnimalTransferHandler;
...
final class UpdateAnimalTransferHandlerTest extends TestCase
{
    public function testHandleUpdatesTransfer(): void
    {
        ...
        $handler = new UpdateAnimalTransferHandler($repository, $eventBus, $clock);
        $handler($command);
    }
