...
namespace App\Tests\Unit\Context\Animal\Domain;
...
final class AnimalTest extends TestCase
{
    ...
    public function testUpdateLifeCycle(): void
    {
        ...
        $lifeCycle = new LifeCycle(
            lifeStatus: \App\Context\Animal\Domain\ValueObject\LifeStatus::DECEASED,
            deceasedAt: $now,
            missingSince: null
        );
    ...
    public function testUpdateTransfer(): void
    {
        ...
        $transfer = new Transfer(
            transferStatus: \App\Context\Animal\Domain\ValueObject\TransferStatus::SOLD,
            soldAt: $now,
            givenAt: null
        );
    ...
    public function testReplaceOwnersThrowsOnDuplicate(): void
    {
        ...
        $this->expectException(\App\Context\Animal\Domain\Exception\DuplicateActiveOwnerException::class);
    ...
    {
        $this->expectException(\App\Context\Animal\Domain\Exception\PrimaryOwnerConflictException::class);
