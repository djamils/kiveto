...
namespace App\Tests\Unit\Context\Clinic\Application\Query\Clinic\ListClinicGroups;
...
use App\Context\Clinic\Application\Query\Clinic\ListClinicGroups\ListClinicGroupsHandler;
...
final class ListClinicGroupsHandlerTest extends TestCase
{
    ...
    {
        $collection = new ClinicGroupCollection([], 0);
