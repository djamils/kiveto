...
namespace App\Tests\Unit\Context\Clinic\Application\Command\Clinic\RenameClinicGroup;

use App\Context\Clinic\Application\Command\Clinic\RenameClinicGroup\RenameClinicGroup;
use App\Context\Clinic\Application\Command\Clinic\RenameClinicGroup\RenameClinicGroupHandler;
...
final class RenameClinicGroupHandlerTest extends TestCase
{
    public function testRenameClinicGroupSuccessfully(): void
    {
        ...
        $handler = new RenameClinicGroupHandler(
            $repo,
