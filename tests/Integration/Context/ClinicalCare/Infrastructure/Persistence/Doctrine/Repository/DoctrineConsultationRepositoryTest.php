...
namespace App\Tests\Integration\Context\ClinicalCare\Infrastructure\Persistence\Doctrine\Repository;
...
final class DoctrineConsultationRepositoryTest extends KernelTestCase
{
    ...
    public function testRoundTripWithFullLifecycle(): void
    {
        ...
        $noteEntity = $em->getRepository(
            \App\Context\ClinicalCare\Infrastructure\Persistence\Doctrine\Entity\ClinicalNoteEntity::class,
        ...
        $actEntity = $em->getRepository(
            \App\Context\ClinicalCare\Infrastructure\Persistence\Doctrine\Entity\PerformedActEntity::class,
        )->findOneBy(['consultationId' => $consultationIdBinary]);
