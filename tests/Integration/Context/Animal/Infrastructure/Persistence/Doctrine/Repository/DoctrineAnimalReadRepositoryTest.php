...
namespace App\Tests\Integration\Context\Animal\Infrastructure\Persistence\Doctrine\Repository;
...
final class DoctrineAnimalReadRepositoryTest extends KernelTestCase
{
    ...
    public function testFindByIdReturnsAnimalView(): void
    {
        ...
        $view = $repo->findById(
            ...
            \App\Context\Animal\Domain\ValueObject\AnimalId::fromString($animalId->toString())
        );
    ...
    public function testFindByIdReturnsNullWhenNotFound(): void
    {
        ...
        $animalId = \App\Context\Animal\Domain\ValueObject\AnimalId::fromString(Uuid::v7()->toString());
