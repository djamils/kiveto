...
readonly class AppointmentPractitionerAssigneeChanged extends AbstractDomainEvent
{
    ...
    public function __construct(
        ...
        private ?string $oldPractitionerUserId,
        private string $newPractitionerUserId,
    ) {
    }
