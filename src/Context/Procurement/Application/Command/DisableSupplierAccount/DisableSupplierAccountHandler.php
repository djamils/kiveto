...
#[AsMessageHandler]
final readonly class DisableSupplierAccountHandler
{
    ...
    public function __invoke(DisableSupplierAccount $command): void
    {
        ...
        $account->disable(updatedAt: $this->clock->now());
