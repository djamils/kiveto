...
class ICADLookupEntity
{
    ...
    #[ORM\Column(type: 'string', length: 16, enumType: ICADLookupStatus::class)]
    ...
    public function getStatus(): ICADLookupStatus
    {
        return $this->status;
    }

    public function setStatus(ICADLookupStatus $status): void
    {
        $this->status = $status;
    }
