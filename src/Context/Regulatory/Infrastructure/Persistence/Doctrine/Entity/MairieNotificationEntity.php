...
#[ORM\Entity]
#[ORM\Table]
class MairieNotificationEntity
{
    #[ORM\Id]
    ...
    #[ORM\Column(type: 'string', length: 16, enumType: MairieNotificationStatus::class)]
    ...
    public function getStatus(): MairieNotificationStatus
    {
        return $this->status;
    }

    public function setStatus(MairieNotificationStatus $status): void
    {
        $this->status = $status;
    }
