...
class StrayCustodyEntity
{
    ...
    #[ORM\Column(type: 'string', length: 32, enumType: StrayCustodyStatus::class)]
    ...
    public function getStatus(): StrayCustodyStatus
    {
        return $this->status;
    }

    public function setStatus(StrayCustodyStatus $status): void
    {
        $this->status = $status;
    }
