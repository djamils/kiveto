...
namespace App\Context\Clinic\Application\Command\Clinic\RenameClinic;
...
#[AsMessageHandler]
final class RenameClinicHandler
{
    ...
    public function __invoke(RenameClinic $command): void
    {
        ...
        $clinic->rename($command->name, $this->clock->now());
