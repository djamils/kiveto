...
namespace App\Context\Clinic\Application\Command\RenameClinicGroup;
...
#[AsMessageHandler]
final class RenameClinicGroupHandler
{
    ...
    public function __invoke(RenameClinicGroup $command): void
    {
        ...
        $clinicGroup->rename($command->name);
