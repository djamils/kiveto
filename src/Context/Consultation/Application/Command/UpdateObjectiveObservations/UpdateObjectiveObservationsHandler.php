...
#[AsMessageHandler]
final readonly class UpdateObjectiveObservationsHandler
{
    ...
    public function __invoke(UpdateObjectiveObservations $command): void
    {
        ...
        $consultation->updateObjectiveObservations($command->text, $this->clock->now());
