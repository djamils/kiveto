...
#[AsMessageHandler]
final readonly class RemovePrescriptionLineHandler
{
    ...
    public function __invoke(RemovePrescriptionLine $command): void
    {
        ...
        $consultation->removePrescriptionLine($command->prescriptionLineId, $this->clock->now());
