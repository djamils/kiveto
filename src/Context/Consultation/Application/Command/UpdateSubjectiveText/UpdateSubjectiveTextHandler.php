...
#[AsMessageHandler]
final readonly class UpdateSubjectiveTextHandler
{
    ...
    public function __invoke(UpdateSubjectiveText $command): void
    {
        ...
        $consultation->updateSubjectiveText($command->text, $this->clock->now());
