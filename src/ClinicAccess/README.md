# ClinicAccess Bounded Context

Le Bounded Context **ClinicAccess** gère l'accès des utilisateurs (staff) aux cliniques dans Kiveto.
...
**Table** : `clinic_access__memberships`
...
**Migrations** : `migrations/ClinicAccess/Version20260110180000.php`
...
`tests/Unit/ClinicAccess/Domain/ClinicMembershipTest.php`
...
`tests/Unit/ClinicAccess/Application/Command/AddUserToClinic/AddUserToClinicHandlerTest.php`
...
```bash
php bin/phpunit tests/Unit/ClinicAccess/
```

## Fixtures

**Factory** : `fixtures/ClinicAccess/Factory/ClinicMembershipEntityFactory.php`

**Story** : `fixtures/ClinicAccess/Story/ClinicMembershipDataStory.php`
