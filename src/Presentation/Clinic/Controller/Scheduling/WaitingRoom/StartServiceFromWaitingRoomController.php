...
#[Route(
    path: '/scheduling/waiting-room/{entryId}/start-service-from-queue',
    name: 'clinic_scheduling_waitingroom_start_from_queue',
    methods: ['POST'],
)]
final class StartServiceFromWaitingRoomController extends AbstractController
{
