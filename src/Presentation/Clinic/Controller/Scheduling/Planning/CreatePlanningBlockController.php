...
#[Route('/scheduling/planning/blocks', name: 'clinic_planning_block_create', methods: ['POST'])]
final class CreatePlanningBlockController extends AbstractController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        try {
            $id = $this->commandBus->dispatch(new CreatePlanningBlock(
